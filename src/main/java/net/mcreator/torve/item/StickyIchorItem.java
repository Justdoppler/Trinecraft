...
public class StickyIchorItem extends TorveElements.ModElement {
	@ObjectHolder("torve:stickyichor")
	public static final Item block = null;
	public StickyIchorItem(TorveElements instance) {
		super(instance, 63);
	}
