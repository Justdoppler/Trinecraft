...
public class EyeOfQbthulhuItem extends TorveElements.ModElement {
	@ObjectHolder("torve:eyeofqbthulhu")
	public static final Item block = null;
	public EyeOfQbthulhuItem(TorveElements instance) {
		super(instance, 39);
	}
