...
public class BleachedBoneItem extends TorveElements.ModElement {
	@ObjectHolder("torve:bleachedbone")
	public static final Item block = null;
	public BleachedBoneItem(TorveElements instance) {
		super(instance, 21);
	}
