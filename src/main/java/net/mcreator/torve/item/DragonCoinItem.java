...
public class DragonCoinItem extends TorveElements.ModElement {
	@ObjectHolder("torve:dragoncoin")
	public static final Item block = null;
	public DragonCoinItem(TorveElements instance) {
		super(instance, 31);
	}
