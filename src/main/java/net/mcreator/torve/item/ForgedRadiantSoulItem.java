...
public class ForgedRadiantSoulItem extends TorveElements.ModElement {
	@ObjectHolder("torve:forgedradiantsoul")
	public static final Item block = null;
	public ForgedRadiantSoulItem(TorveElements instance) {
		super(instance, 43);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("forgedradiantsoul");
		}
