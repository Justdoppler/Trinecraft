...
public class AcientScaleItem extends TorveElements.ModElement {
	@ObjectHolder("torve:acientscale")
	public static final Item block = null;
	public AcientScaleItem(TorveElements instance) {
		super(instance, 19);
	}
