...
public class ArenaCoinItem extends TorveElements.ModElement {
	@ObjectHolder("torve:arenacoin")
	public static final Item block = null;
	public ArenaCoinItem(TorveElements instance) {
		super(instance, 20);
	}
