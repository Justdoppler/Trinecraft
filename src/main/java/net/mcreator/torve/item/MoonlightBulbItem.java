...
public class MoonlightBulbItem extends TorveElements.ModElement {
	@ObjectHolder("torve:moonlightbulb")
	public static final Item block = null;
	public MoonlightBulbItem(TorveElements instance) {
		super(instance, 51);
	}
