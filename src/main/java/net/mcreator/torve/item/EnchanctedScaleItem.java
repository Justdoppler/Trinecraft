...
public class EnchanctedScaleItem extends TorveElements.ModElement {
	@ObjectHolder("torve:enchanctedscale")
	public static final Item block = null;
	public EnchanctedScaleItem(TorveElements instance) {
		super(instance, 36);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("enchanctedscale");
		}
