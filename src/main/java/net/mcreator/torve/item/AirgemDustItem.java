...
public class AirgemDustItem extends TorveElements.ModElement {
	@ObjectHolder("torve:airgemdust")
	public static final Item block = null;
	public AirgemDustItem(TorveElements instance) {
		super(instance, 18);
	}
