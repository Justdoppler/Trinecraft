...
public class ShadowShardItem extends TorveElements.ModElement {
	@ObjectHolder("torve:shadowshard")
	public static final Item block = null;
	public ShadowShardItem(TorveElements instance) {
		super(instance, 60);
	}
