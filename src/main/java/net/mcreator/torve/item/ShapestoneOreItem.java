...
public class ShapestoneOreItem extends TorveElements.ModElement {
	@ObjectHolder("torve:shapestoneore")
	public static final Item block = null;
	public ShapestoneOreItem(TorveElements instance) {
		super(instance, 61);
	}
