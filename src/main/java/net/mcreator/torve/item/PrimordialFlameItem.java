...
public class PrimordialFlameItem extends TorveElements.ModElement {
	@ObjectHolder("torve:primordialflame")
	public static final Item block = null;
	public PrimordialFlameItem(TorveElements instance) {
		super(instance, 57);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("primordialflame");
		}
