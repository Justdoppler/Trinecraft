...
public class SomberSoulItem extends TorveElements.ModElement {
	@ObjectHolder("torve:sombersoul")
	public static final Item block = null;
	public SomberSoulItem(TorveElements instance) {
		super(instance, 62);
	}
