...
public class LapisLadybugItem extends TorveElements.ModElement {
	@ObjectHolder("torve:lapisladybug")
	public static final Item block = null;
	public LapisLadybugItem(TorveElements instance) {
		super(instance, 68);
	}
