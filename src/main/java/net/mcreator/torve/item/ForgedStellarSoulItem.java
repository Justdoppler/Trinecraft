...
public class ForgedStellarSoulItem extends TorveElements.ModElement {
	@ObjectHolder("torve:forgedstellarsoul")
	public static final Item block = null;
	public ForgedStellarSoulItem(TorveElements instance) {
		super(instance, 42);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("forgedstellarsoul");
		}
