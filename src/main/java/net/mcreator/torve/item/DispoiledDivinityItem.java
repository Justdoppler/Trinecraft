...
public class DispoiledDivinityItem extends TorveElements.ModElement {
	@ObjectHolder("torve:dispoileddivinity")
	public static final Item block = null;
	public DispoiledDivinityItem(TorveElements instance) {
		super(instance, 33);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("dispoileddivinity");
		}
