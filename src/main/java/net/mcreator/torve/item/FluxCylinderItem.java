...
public class FluxCylinderItem extends TorveElements.ModElement {
	@ObjectHolder("torve:fluxcylinder")
	public static final Item block = null;
	public FluxCylinderItem(TorveElements instance) {
		super(instance, 28);
	}
