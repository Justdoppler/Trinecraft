...
public class DiamondDragoniteItem extends TorveElements.ModElement {
	@ObjectHolder("torve:diamonddragonite")
	public static final Item block = null;
	public DiamondDragoniteItem(TorveElements instance) {
		super(instance, 32);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("diamonddragonite");
		}
