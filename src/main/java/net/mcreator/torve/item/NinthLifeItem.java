...
public class NinthLifeItem extends TorveElements.ModElement {
	@ObjectHolder("torve:ninthlife")
	public static final Item block = null;
	public NinthLifeItem(TorveElements instance) {
		super(instance, 67);
	}
