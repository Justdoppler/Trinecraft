...
public class EnchantedwoodItem extends TorveElements.ModElement {
	@ObjectHolder("torve:enchantedwood")
	public static final Item block = null;
	public EnchantedwoodItem(TorveElements instance) {
		super(instance, 35);
	}
