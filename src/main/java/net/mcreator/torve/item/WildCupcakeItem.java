...
public class WildCupcakeItem extends TorveElements.ModElement {
	@ObjectHolder("torve:wildcupcake")
	public static final Item block = null;
	public WildCupcakeItem(TorveElements instance) {
		super(instance, 14);
	}
