...
public class RadiantShardItem extends TorveElements.ModElement {
	@ObjectHolder("torve:radiantshard")
	public static final Item block = null;
	public RadiantShardItem(TorveElements instance) {
		super(instance, 58);
	}
