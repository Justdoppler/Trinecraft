...
import net.mcreator.torve.procedures.RegenProcedure;
...
public class FlaskItem extends TorveElements.ModElement {
	@ObjectHolder("torve:flask")
	public static final Item block = null;
	public FlaskItem(TorveElements instance) {
		super(instance, 112);
	}
	...
	public static class FoodItemCustom extends Item {
		...
		public ItemStack onItemUseFinish(ItemStack itemStack, World world, LivingEntity entity) {
			...
			int z = (int) entity.posZ;
			{
				...
				RegenProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
