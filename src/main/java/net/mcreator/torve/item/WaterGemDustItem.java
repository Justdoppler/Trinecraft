...
public class WaterGemDustItem extends TorveElements.ModElement {
	@ObjectHolder("torve:watergemdust")
	public static final Item block = null;
	public WaterGemDustItem(TorveElements instance) {
		super(instance, 66);
	}
