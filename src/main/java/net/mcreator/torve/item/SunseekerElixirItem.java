...
public class SunseekerElixirItem extends TorveElements.ModElement {
	@ObjectHolder("torve:sunseekerelixir")
	public static final Item block = null;
	public SunseekerElixirItem(TorveElements instance) {
		super(instance, 13);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("sunseekerelixir");
		}
