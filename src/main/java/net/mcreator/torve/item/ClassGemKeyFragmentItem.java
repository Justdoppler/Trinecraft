...
public class ClassGemKeyFragmentItem extends TorveElements.ModElement {
	@ObjectHolder("torve:classgemkeyfragment")
	public static final Item block = null;
	public ClassGemKeyFragmentItem(TorveElements instance) {
		super(instance, 27);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("classgemkeyfragment");
		}
