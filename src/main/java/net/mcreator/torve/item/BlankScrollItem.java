...
public class BlankScrollItem extends TorveElements.ModElement {
	@ObjectHolder("torve:blankscroll")
	public static final Item block = null;
	public BlankScrollItem(TorveElements instance) {
		super(instance, 23);
	}
