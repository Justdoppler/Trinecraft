...
public class BoundBrillianceItem extends TorveElements.ModElement {
	@ObjectHolder("torve:boundbrilliance")
	public static final Item block = null;
	public BoundBrillianceItem(TorveElements instance) {
		super(instance, 25);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("boundbrilliance");
		}
