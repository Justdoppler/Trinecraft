...
public class QuadForgedShadowSoulItem extends TorveElements.ModElement {
	@ObjectHolder("torve:quadforgedshadowsoul")
	public static final Item block = null;
	public QuadForgedShadowSoulItem(TorveElements instance) {
		super(instance, 55);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("quadforgedshadowsoul");
		}
