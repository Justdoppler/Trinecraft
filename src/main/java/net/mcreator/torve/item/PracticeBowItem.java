...
public class PracticeBowItem extends TorveElements.ModElement {
	@ObjectHolder("torve:practicebow")
	public static final Item block = null;
	@ObjectHolder("torve:entitybulletpracticebow")
	public static final EntityType arrow = null;
	public PracticeBowItem(TorveElements instance) {
		super(instance, 74);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletpracticebow").setRegistryName("entitybulletpracticebow"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(TroveIconItemGroup.tab).maxDamage(100));
			setRegistryName("practicebow");
		}
		...
		public Multimap<String, AttributeModifier> getAttributeModifiers(EquipmentSlotType slot) {
			...
			if (slot == EquipmentSlotType.MAINHAND) {
				multimap.put(SharedMonsterAttributes.ATTACK_DAMAGE.getName(),
						new AttributeModifier(ATTACK_DAMAGE_MODIFIER, "ranged_item_damage", (double) 6, AttributeModifier.Operation.ADDITION));
