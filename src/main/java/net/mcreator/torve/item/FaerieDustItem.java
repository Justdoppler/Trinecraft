...
public class FaerieDustItem extends TorveElements.ModElement {
	@ObjectHolder("torve:faeriedust")
	public static final Item block = null;
	public FaerieDustItem(TorveElements instance) {
		super(instance, 40);
	}
