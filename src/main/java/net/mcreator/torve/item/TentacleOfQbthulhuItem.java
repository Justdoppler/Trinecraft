...
public class TentacleOfQbthulhuItem extends TorveElements.ModElement {
	@ObjectHolder("torve:tentacleofqbthulhu")
	public static final Item block = null;
	public TentacleOfQbthulhuItem(TorveElements instance) {
		super(instance, 65);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("tentacleofqbthulhu");
		}
