...
public class EmpoweredGemFragmentItem extends TorveElements.ModElement {
	@ObjectHolder("torve:empoweredgemfragment")
	public static final Item block = null;
	public EmpoweredGemFragmentItem(TorveElements instance) {
		super(instance, 37);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("empoweredgemfragment");
		}
