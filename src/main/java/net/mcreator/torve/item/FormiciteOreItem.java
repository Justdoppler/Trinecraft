...
public class FormiciteOreItem extends TorveElements.ModElement {
	@ObjectHolder("torve:formiciteore")
	public static final Item block = null;
	public FormiciteOreItem(TorveElements instance) {
		super(instance, 41);
	}
