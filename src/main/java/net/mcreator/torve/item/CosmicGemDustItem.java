...
public class CosmicGemDustItem extends TorveElements.ModElement {
	@ObjectHolder("torve:cosmicgemdust")
	public static final Item block = null;
	public CosmicGemDustItem(TorveElements instance) {
		super(instance, 29);
	}
