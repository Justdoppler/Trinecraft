...
public class GlacialShardItem extends TorveElements.ModElement {
	@ObjectHolder("torve:glacialshard")
	public static final Item block = null;
	public GlacialShardItem(TorveElements instance) {
		super(instance, 46);
	}
