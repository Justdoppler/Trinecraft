...
public class GoldenSoulItem extends TorveElements.ModElement {
	@ObjectHolder("torve:goldensoul")
	public static final Item block = null;
	public GoldenSoulItem(TorveElements instance) {
		super(instance, 48);
	}
