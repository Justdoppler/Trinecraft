...
public class DoubleXPPotionItem extends TorveElements.ModElement {
	@ObjectHolder("torve:doublexppotion")
	public static final Item block = null;
	public DoubleXPPotionItem(TorveElements instance) {
		super(instance, 15);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("doublexppotion");
		}
