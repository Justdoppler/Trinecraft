...
public class CrystalCloudsItem extends TorveElements.ModElement {
	@ObjectHolder("torve:crystalclouds")
	public static final Item block = null;
	public CrystalCloudsItem(TorveElements instance) {
		super(instance, 30);
	}
