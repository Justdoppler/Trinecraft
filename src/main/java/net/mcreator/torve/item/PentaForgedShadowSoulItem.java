...
public class PentaForgedShadowSoulItem extends TorveElements.ModElement {
	@ObjectHolder("torve:pentaforgedshadowsoul")
	public static final Item block = null;
	public PentaForgedShadowSoulItem(TorveElements instance) {
		super(instance, 54);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("pentaforgedshadowsoul");
		}
