...
public class BindingDarknessItem extends TorveElements.ModElement {
	@ObjectHolder("torve:bindingdarkness")
	public static final Item block = null;
	public BindingDarknessItem(TorveElements instance) {
		super(instance, 22);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("bindingdarkness");
		}
