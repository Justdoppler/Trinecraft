...
public class LunarSoulItem extends TorveElements.ModElement {
	@ObjectHolder("torve:lunarsoul")
	public static final Item block = null;
	public LunarSoulItem(TorveElements instance) {
		super(instance, 50);
	}
