...
public class MushroomChunksItem extends TorveElements.ModElement {
	@ObjectHolder("torve:mushroomchunks")
	public static final Item block = null;
	public MushroomChunksItem(TorveElements instance) {
		super(instance, 52);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("mushroomchunks");
		}
