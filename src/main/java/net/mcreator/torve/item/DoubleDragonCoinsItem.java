...
public class DoubleDragonCoinsItem extends TorveElements.ModElement {
	@ObjectHolder("torve:doubledragoncoins")
	public static final Item block = null;
	public DoubleDragonCoinsItem(TorveElements instance) {
		super(instance, 16);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("doubledragoncoins");
		}
