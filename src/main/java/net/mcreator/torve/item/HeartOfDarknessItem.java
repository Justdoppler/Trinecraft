...
public class HeartOfDarknessItem extends TorveElements.ModElement {
	@ObjectHolder("torve:heartofdarkness")
	public static final Item block = null;
	public HeartOfDarknessItem(TorveElements instance) {
		super(instance, 47);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("heartofdarkness");
		}
