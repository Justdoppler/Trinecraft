...
public class FireGemDustItem extends TorveElements.ModElement {
	@ObjectHolder("torve:firegemdust")
	public static final Item block = null;
	public FireGemDustItem(TorveElements instance) {
		super(instance, 38);
	}
