...
public class PearlOfWisdomItem extends TorveElements.ModElement {
	@ObjectHolder("torve:pearlofwisdom")
	public static final Item block = null;
	public PearlOfWisdomItem(TorveElements instance) {
		super(instance, 53);
	}
