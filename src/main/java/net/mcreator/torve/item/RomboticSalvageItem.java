...
public class RomboticSalvageItem extends TorveElements.ModElement {
	@ObjectHolder("torve:romboticsalvage")
	public static final Item block = null;
	public RomboticSalvageItem(TorveElements instance) {
		super(instance, 59);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("romboticsalvage");
		}
