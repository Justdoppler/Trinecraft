...
public class ConfetiBallItem extends TorveElements.ModElement {
	@ObjectHolder("torve:confetiball")
	public static final Item block = null;
	public ConfetiBallItem(TorveElements instance) {
		super(instance, 17);
	}
